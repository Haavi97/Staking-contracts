...
contract Vesting is Ownable {
    ...
    //*********CONSTRUCTOR*************
    constructor(address _tokenAddress, uint _baseReward, uint _apy, uint _swapRate, uint _timePeriod) {
        tokenA = IERC20(_token);
    ...
    function addWorker(address _worker) external onlyOwner {
        require(workersMapping[_worker].startTime == 0, "Worker already exists");
    ...
    function claimReward() external onlyWorkers isClaimOpen {
